...
DATA(insert OID = 5052 ( gp_bring_up_segments  PGNSP PGUID 12 1 0 0 0 f f f f f f v 0 0 23 "" _null_ _null_ _null_ _null_ gp_bring_up_segments _null_ _null_ _null_ n a ));
...
/* gp_expand_unlock_catalog() => void */
DATA(insert OID = 5081 ( gp_expand_unlock_catalog  PGNSP PGUID 12 1 0 0 0 f f f f f f v 0 0 2278 "" _null_ _null_ _null_ _null_ gp_expand_unlock_catalog _null_ _null_ _null_ n a ));
DESCR("Unlock catalog changes for gpexpand");
